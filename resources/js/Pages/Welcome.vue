...
<template>
    ...
    <div class="text-center justify-center items-center">
        <h1 class="mt-10 text-4xl font-bold font-mono text-center text-white">Admin Control Panel</h1>
        <button @click="enableModal" class="bg-green-600 p-3 rounded-full m-5">Create New Entry</button>
        <div class="bg-slate-700 max-w-7xl m-auto p-5">
            <ControlPanel :theDataControl="daData" />
        </div>
    </div>
    <modal :myTitle="modalTitle" :theType="modalType" :theData="daData" v-if="showCreateModal"
